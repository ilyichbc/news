...
export const siteConfig: SiteConfig = {
	title: "星籁浮屿资讯站",
	subtitle: "分享最新资讯",
	siteURL: "https://ilyich.top/news/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "https://cdn.jsdelivr.net/gh/ilyichbc/cdn/luminoa-site-CDN/img/logo.png",
		// 网站Logo图片路径
		logo: "https://cdn.jsdelivr.net/gh/ilyichbc/cdn/luminoa-site-CDN/img/logo.png",
	},
	...
	banner: {
		...
		homeText: {
			...
			title: "星籁浮屿资讯站", // 主页横幅主标题

			subtitle: [
				"有些事情我不看透，不是我笨，只是我太善良。",
				"越想贴近事实，不明白的事情就越多。",
				"每个点发出的射线能相交就是一件不可思议的事。",
				"人生本就是一场穿透黑暗的白色飞行。",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		//{
		//	name: "Bilibili",
		//	url: "https://space.bilibili.com/18224825",
		//	external: true,
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	// 侧栏组件布局配置
	components: {
		left: ["announcement", "tags", "site-stats", "categories"],
		right: [],
